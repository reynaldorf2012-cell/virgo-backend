...
def servicio_to_response(s: dict) -> Servicio:
    ...
    return Servicio(
        ...
        fecha_cita=(s.get("fecha_cita").isoformat() if isinstance(s.get("fecha_cita"), datetime) else str(s.get("fecha_cita"))) if s.get("fecha_cita") else None,  # Legacy backward compat
        # Estado
        estado=s["estado"],
